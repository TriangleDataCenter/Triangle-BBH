...
Also offered is an illustrative example (Example 4) for the preliminary analysis of **Taiji Data Challenge**, nevertheless, it **should not** be regarded as a solution to all the challenges. 
